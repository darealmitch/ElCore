export const classDescriptions = [
    ...
    },
    {
        ...
        jobStage: "job3",
        title: "Le cavalier fantôme sur le chemin de la vengeance : la 4e voie de Raven sort enfin !",
        path: ["Venimophore", "Métalame", "Âme fatale"],
        presentation:
            "Cette classe plante les graines d'une plante parasitaire dans ses adversaires pour les détruire de l'intérieur.",
        attackType: "Attaque",
        attackRange: "Moyenne",
    },
    ...
    },
    {
        ...
        path: [],
        presentation:
            "Cette cavalière de la mort est assoiffée de sang. La Reine sanglante possède une force destructrice issue de l'art occulte de manier l'épée, qui lui permet d'exterminer tous ses ennemis.",
        attackType: "",
        attackRange: "",
    },
    {
        ...
        jobStage: "job3",
        title:
            "Repoussant sa destinée oppressante, Elesis, l'épée à la main, prend un nouveau chemin pour protéger réellement Élios.",
        path: ["Chevalier fauconnier", "Patrona", "Adrestia"],
        presentation:
            "Armée de l'épée sacrée Divinus Manus, tu te bats n'importe où et contre n'importe quelle horde pour rester fidèle à ton noble objectif.",
        attackType: "Attaque magique",
        attackRange: "Moyenne",
    },
    ...
    },
    {
        ...
        path: [],
        presentation:
            "Voici la reine démoniaque de la destruction et son fidèle serviteur. Enveloppés d'énergie démoniaque noire comme le jais, ils exécutent chaque ennemi sans hésitation.",
        attackType: "",
        attackRange: "",
    },
    {
        ...
        jobStage: "job3",
        title:
            "La 4e voie de Lu/Ciel est enfin publiée ! La souveraine sombrant dans le vide et son sauveur impitoyable",
        path: ["Isolatesse", "Tristesso", "Demersio"],
        presentation:
            "Id et Ego se sont manifestés dans l'abysse. En fonction de la situation pendant un combat, cette classe peut choisir de jouer l'un de ces rôles.",
        attackType: "Attaque magique",
        attackRange: "Moyenne",
    },
    ...
    },
    {
        ...
        presentation:
            "Laby se replie de plus en plus sur elle-même et demande de l'aide à son miroir Nisha. Pour protéger Laby, Nisha décide de prendre le contrôle de toutes ses émotions.",
        attackType: "",
        attackRange: "",
    },
...

    {
        ...
        classNameFr: "Morphée",
        jobStage: "job3",
        title: "Un voyageur onirique qui fuit la réalité : mise à jour pour la 4e voie de Noah",
    ...
    },
    {
        ...
        presentation:
            "Lithia utilise et perfectionne des sorts démoniaques pour attirer ses adversaires et les exterminer impitoyablement.",
        attackType: "",
        attackRange: "",
    },
];